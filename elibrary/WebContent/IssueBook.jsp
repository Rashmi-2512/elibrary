...
<div class="topnav">
  ...
  <a href="ViewBook.jsp">View Book</a>
   <a href="IssueBook.jsp" class="active">Issue Book</a>
...
<form name="frm_issueBook" method="post" action="/eLibrary/IssueBooks" style="margin-left:100px;margin-top:50px;">
<table cellspacing="5px">
	<tr>
	<th align="left">Issue Book Form</th>
	</tr>
	...
	<tr><td><input type="submit" value="Issue Book" onclick="return validate_issueBookfr()"/></td></tr>
